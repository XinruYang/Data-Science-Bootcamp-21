...
# Visualize in six plots, 3 for each row
def visualizacion_six(data, suptitle, x1, x2, x3, y, t1, t2, t3, t4, t5, t6, n):
...
# Visualize in six plots, 3 for each row
def visualizacion_eight(data, suptitle, x1, x2, x3, x4, y, t1, t2, t3, t4, t5, t6,t7, t8, n):
...
def scatter_geo(df, size, name, color, size_max=None): 
    ...
    fig.update_traces(marker=dict(size=90))
